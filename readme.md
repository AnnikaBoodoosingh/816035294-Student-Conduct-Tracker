...
```bash
$ flask student get_by_id student_id
```

Example

```bash
$ flask student get_by_id 1
```
# Review Student
...
```bash
$ flask student review student_id review_type comments
```
...
To view all reviews for a specific student
